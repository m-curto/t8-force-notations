...
const std::array<std::pair<fs::path,const char *>, PAKS_MAX> get_paths() {
    ...
    arr[XBOX_VERTICAL_1] = { fs::path(PAKS_FOLDER) / XBXV_FOLDER / ONE_FOLDER,      "resources/xbox_vertical/xbox_vertical_1.bmp" };
    arr[XBOX_VERTICAL_2] = { fs::path(PAKS_FOLDER) / XBXV_FOLDER / TWO_FOLDER,      "resources/xbox_vertical/xbox_vertical_2.bmp" };
    arr[XBOX_VERTICAL_3] = { fs::path(PAKS_FOLDER) / XBXV_FOLDER / THREE_FOLDER,    "resources/xbox_vertical/xbox_vertical_3.bmp" };
    arr[XBOX_VERTICAL_4] = { fs::path(PAKS_FOLDER) / XBXV_FOLDER / FOUR_FOLDER,     "resources/xbox_vertical/xbox_vertical_4.bmp" };
    arr[XBOX_VERTICAL_DARK_1] = { fs::path(PAKS_FOLDER) / XBXVD_FOLDER / ONE_FOLDER,    "resources/xbox_vertical_dark/xbox_vertical_dark_1.bmp" };
    arr[XBOX_VERTICAL_DARK_2] = { fs::path(PAKS_FOLDER) / XBXVD_FOLDER / TWO_FOLDER,    "resources/xbox_vertical_dark/xbox_vertical_dark_2.bmp" };
    arr[XBOX_VERTICAL_DARK_3] = { fs::path(PAKS_FOLDER) / XBXVD_FOLDER / THREE_FOLDER,  "resources/xbox_vertical_dark/xbox_vertical_dark_3.bmp" };
    arr[XBOX_VERTICAL_DARK_4] = { fs::path(PAKS_FOLDER) / XBXVD_FOLDER / FOUR_FOLDER,   "resources/xbox_vertical_dark/xbox_vertical_dark_4.bmp" };
